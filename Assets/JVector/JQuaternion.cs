...
namespace JuhaKurisu.JVector
{
    public struct Quaterniond
    {
        ...
        public JVector3 eulerAngles
        {
            get
            {
                JMatrix4x4 m = QuaternionToMatrix(this);
        ...
        public static Quaterniond AngleAxis(double angle, JVector3 axis)
        {
        ...
        public static Quaterniond Euler(JVector3 euler)
        {
        ...
        public static Quaterniond FromToRotation(JVector3 fromDirection, JVector3 toDirection)
        {
        ...
        public static Quaterniond LookRotation(JVector3 forward)
        {
            JVector3 up = JVector3.up;
            return LookRotation(forward, up);
        }
        public static Quaterniond LookRotation(JVector3 forward, [DefaultValue("JVector3.up")] JVector3 upwards)
        {
            JMatrix4x4 m = LookRotationToMatrix(forward, upwards);
        ...
        public void SetFromToRotation(JVector3 fromDirection, JVector3 toDirection)
        {
            this = FromToRotation(fromDirection, toDirection);
        }
        public void SetLookRotation(JVector3 view)
        {
            this = LookRotation(view);
        }
        public void SetLookRotation(JVector3 view, [DefaultValue("JVector3.up")] JVector3 up)
        {
            this = LookRotation(view, up);
        }
        public void ToAngleAxis(out double angle, out JVector3 axis)
        {
        ...
        private JVector3 MatrixToEuler(JMatrix4x4 m)
        {
            JVector3 v = new JVector3();
            if (m[1, 2] < 1)
            {
                if (m[1, 2] > -1)
                {
        ...
        public static JMatrix4x4 QuaternionToMatrix(Quaterniond quat)
        {
        ...
        private static Quaterniond MatrixToQuaternion(JMatrix4x4 m)
        {
        ...
        private static JMatrix4x4 LookRotationToMatrix(JVector3 viewVec, JVector3 upVec)
        {
            JVector3 z = viewVec;
            JMatrix4x4 m = new JMatrix4x4();

            double mag = JVector3.Magnitude(z);
            if (mag < 0)
            {
                m = JMatrix4x4.identity;
            }
            z /= mag;

            JVector3 x = JVector3.Cross(upVec, z);
            mag = JVector3.Magnitude(x);
            if (mag < 0)
            {
                m = JMatrix4x4.identity;
            }
        ...
        public static JVector3 operator *(Quaterniond rotation, JVector3 point)
        {
